...
const AddStudent = () => {
  ...
  // CHANGE 1: Updated formData state.
  // - Removed `admissionNo`, `loginId`, and `password` as they are no longer user-controlled.
  // - Replaced `classId` with `className` to align with the new insertion logic.
  ...
  return (
    <div className="container-fluid p-3">
      ...
      {/* Row 3: Classes Display (Unchanged)
